 ...
 */
public class CachingEventPageTest {

	@Test
	public void testCaching() throws InterruptedException {

		PageTester pageTester = new PageTester("uk.co.ioko.tapestry.caching", "Cache", "src/test/webapp");
		...
		*/
		...
		Thread.sleep(1000);
		Document page3 = pageTester.renderPage("CachingEventPage");
