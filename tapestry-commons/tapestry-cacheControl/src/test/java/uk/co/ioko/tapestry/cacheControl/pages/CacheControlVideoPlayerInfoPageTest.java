 ...
 * 
 */
public class CacheControlVideoPlayerInfoPageTest {

	@Test
	public void testDisabledAjaxEvents(){
		PageTester pageTester = new PageTester("uk.co.ioko.tapestry.cacheControl", "Test", "src/test/webapp");
		Document page1 = pageTester.renderPage("CacheControlVideoPlayerInfoTestPage");
